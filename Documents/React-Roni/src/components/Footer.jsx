...
const Footer = () => {
  return (
    ...
    {/* Info Footer */}
    <p className='text-center my-5'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Reiciendis temporibus id aut accusamus aliquam possimus corrupti repudiandae doloremque illum ullam quos cumque voluptates neque, illo error tempore eius et, mollitia consequuntur atque quisquam laborum laboriosam alias odio? Rem corporis iste consequatur cumque sunt, atque officiis sit odit ullam facilis quam?</p>
    
    {/* Icon Media Sosial Footer */}
    <div className='icon justify-content-center mb-5 gap-3 pb-5 d-flex'>
      <a href='#'>
